...
> = {
  ko: {
    ...
    reminderMessage: "내일 반납 예정인 예약이 있습니다. 반납 정보를 확인해 주세요.",
    returnInfo: "반납 정보",
    date: "날짜",
    time: "시간",
    method: "반납 방법",
  ...
  en: {
    preview: "Your return is tomorrow",
    title: "Return Reminder",
    badge: "D-1",
    greeting: (name) => `Hello, ${name}`,
    reminderMessage: "You have a return scheduled for tomorrow. Please review the details below.",
  ...
  ja: {
    ...
    reminderMessage: "明日返却予定のご予約がございます。返却情報をご確認ください。",
    returnInfo: "返却情報",
    date: "日付",
    time: "時間",
    method: "返却方法",
  ...
  "zh-TW": {
    ...
    reminderMessage: "您有一筆預約明天歸還。請確認以下歸還資訊。",
    returnInfo: "歸還資訊",
    date: "日期",
    time: "時間",
    method: "歸還方式",
  ...
  "zh-CN": {
    ...
    badge: "D-1",
    greeting: (name) => `您好，${name}`,
    reminderMessage: "您有一笔预约明天归还。请确认以下归还信息。",
    returnInfo: "归还信息",
    date: "日期",
    time: "时间",
    method: "归还方式",
...
export const ReturnReminderEmail = ({
  customerName,
  reservationNumber,
  productName,
  returnDate,
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={titleSection}>
            <Text style={dDayBadge}>{t.badge}</Text>
          ...
          <Section style={content}>
            ...
            <Section style={returnCard}>
              ...
              <Row style={infoRow}>
                ...
                <Column style={valueColumn}><Text style={valueTextBold}>{returnTime}</Text></Column>
              </Row>
            ...
            <Section style={detailsSection}>
              <Row style={infoRow}>
                <Column style={labelColumn}><Text style={labelText}>{t.product}</Text></Column>
                <Column style={valueColumn}><Text style={valueText}>{productName}</Text></Column>
              </Row>
              <Row style={infoRow}>
...
ReturnReminderEmail.PreviewProps = {
  customerName: "홍길동",
  ...
  locale: "ko",
  partnerName: "ABC 렌탈",
} satisfies ReturnReminderEmailProps;
...
const dDayBadge = { fontSize: "16px", fontWeight: "700", color: "#ffffff", backgroundColor: "#FF6600", padding: "6px 16px", borderRadius: "20px", display: "inline-block", margin: "0 0 16px" };
...
const returnCard = { backgroundColor: "#eff6ff", borderRadius: "12px", padding: "20px", margin: "24px 0", border: "1px solid #bfdbfe" };
const cardTitle = { color: "#1d4ed8", fontSize: "14px", fontWeight: "600", margin: "0 0 12px" };
const cardDivider = { borderColor: "#bfdbfe", margin: "0 0 16px" };
...
const detailsSection = { backgroundColor: "#f8f9fa", borderRadius: "8px", padding: "16px", margin: "0 0 24px" };
